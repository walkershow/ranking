...
if prog_md5 == "all" then
    ...
    sql = "select b.id as gameid,name,iconurl,type, CAST(UNIX_TIMESTAMP() AS UNSIGNED) updatesign,progmd5,jburl,prog_title,"..
...
local putdata = string.format("act=del&userid=%s&gameid=%d",uri_args.userid, gameid)
